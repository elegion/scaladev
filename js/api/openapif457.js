...
w.fastXDM = {
  _id: 0,
  helperUrl: ((location.protocol === 'index-2.html') ? 'https:' : 'http:') + '//vk.com/js/api/xdmHelper.js',
...
if (VK._protocol !== 'index-2.html') {
  VK._protocol = ((location.protocol === 'index-2.html') ? 'https:' : 'http:');
}
